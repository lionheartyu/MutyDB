...
void array_testcase10w(int connfd){
	int i =0;
	int count=100000;
	for(i=0;i<count;i++){
...
void rbtree_testcase(int connfd) {
	...
	test_case(connfd, "RSET Name King", "SUCCESS", "RSETCase");
	test_case(connfd, "RGET Name", "King", "GETCase");
	test_case(connfd, "RMOD Name Darren", "SUCCESS", "RMODCase");
	test_case(connfd, "RGET Name", "Darren", "RGETCase");
	test_case(connfd, "RDEL Name", "SUCCESS", "RDELCase");
	test_case(connfd, "RGET Name", "NO EXIST", "RGETCase");

}

void rbtree_testcase10w(int connfd){
	int i =0;
	int count=100000;
	for(i=0;i<count;i++){
...
void rbtree_testcase_5w_node(int connfd){
	...
	for(i=0;i<count;i++){
		...
		char reslult[128]={0};
		sprintf(reslult,"%d",i+1);
		test_case(connfd, "RCOUNT", reslult, "RCOUNT");
	}
...
void hash_testcase(int connfd) {
	...
	test_case(connfd, "HGET Name", "King", "HETCase");
...
void hash_testcase10w(int connfd){
	int i =0;
	int count=100000;
	for(i=0;i<count;i++){
...
void hash_testcase_5w_node(int connfd){
	...
	for(i=0;i<count;i++){
		...
		char reslult[128]={0};
		sprintf(reslult,"%d",i+1);
		test_case(connfd, "HCOUNT", reslult, "HCOUNT");
	}
